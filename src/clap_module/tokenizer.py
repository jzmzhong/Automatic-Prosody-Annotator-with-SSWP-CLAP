...
def tokenize(texts: Union[str, List[str]], context_length: int = 77) -> torch.LongTensor:
    ...
    Args:
        ...
        context_length (int, optional): The context length to use; all CLIP models use 77 as the context length.
            Defaults to 77.

    Returns:
        result (torch.LongTensor): A two-dimensional tensor containing the resulting tokens,
